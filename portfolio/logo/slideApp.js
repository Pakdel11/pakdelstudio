const images = [
    'img/img/header/YarharLogo.png',
    'img/img/header/dignitiLogo.png',
    'img/img/header/FarzadLogo.png',
    'img/img/header/IranLogo.png',
    'img/img/header/lightNVSLogo.png',
    'img/img/header/likamediaLogo.png'
];
...
slider.addEventListener('click', () => {
    ...
    if (toggleImg == false) {
        ...
        slider.style.cssText = "width: 80%; height: auto; transform: scale(1); border-radius: 0px;";
