const images = [
    'img/img/header/codspx.png',
    'img/img/header/ex.png',
    'img/img/header/pakdel.png',
    'img/img/header/cod.png',
    'img/img/header/rahraz.png',
    'img/img/header/victoria.png',
    'img/img/header/Fibeon.png',
    'img/img/header/codv2.png'
];
...
slider.addEventListener('click', () => {
    ...
    if (toggleImg == false) {
        document.getElementById("second-f").style.display = "none";
        slider.style.cssText = "width: 100%; height: auto; transform: scale(1); border-radius: 0px;";
        ...
        document.getElementById("second-f").style.display = "flex";
