const images = [
    'img/img/header/avatarTs.jpg',
    'img/img/header/avatarpkd.jpg',
    'img/img/header/avatarS.jpg'
];
...
slider.addEventListener('click', () => {
    ...
    if (toggleImg == false) {
        ...
        slider.style.cssText = "width: 40%; height: auto; transform: scale(1); border-radius: 0px;";
...
function myFunction(x) {
    if (x.matches) {
        ...
        slider.style.cssText = "width: 50%; height: auto; transform: scale(1.1); border-radius: 0px;";
